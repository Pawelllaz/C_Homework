...
hW[0] = CreateThread( NULL, 0, ZNAK, &zn1, CREATE_SUSPENDED, &ID0);
hW[1] = CreateThread( NULL, 0, ZNAK, &zn2, CREATE_SUSPENDED, &ID1);
...
DWORD WINAPI ZNAK(LPVOID lpzn)  	// 30 znakow z parametru lpzn        
{
for(int i = 0; i < 60; i++)	{
