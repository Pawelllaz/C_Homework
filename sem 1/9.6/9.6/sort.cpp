...
void selection_sort_asc(int tab[], int size)
{
	...
	printf("sortowanie przez wybieranie: %d\n", counter);
}
//=======================================================
void selection_sort_desc(int tab[], int size)
{
	...
	printf("sortowaie przez wybieranie %d\n", counter);
}
//=========================================================
...
void insertion_sort_asc(int tab[], int size)
{
	...
	printf("sortowanie przez wstawianie: %d\n", counter);
	//display_vector(tab, size);
}
//=======================================================
